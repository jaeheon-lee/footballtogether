...
//		session.insert("sql.footBAllTogether.mapper.insertVote", vote);
//		session.commit();
...
//		
//		session.insert("sql.footBAllTogether.mapper.insertVoteResult", voteResult);
//		session.commit();
...
//		voteResult.setVoteId(30);
//		
//		session.insert("sql.footBAllTogether.mapper.updateVoteResult", voteResult);
//		session.commit();
