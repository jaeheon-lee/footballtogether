...
public class ReviewFromTeam {
	...
	public ReviewFromTeam() {
		super();
	}

	public ReviewFromTeam(int attendantId, int mannerPromise, int mannerContact, int mannerRule, int mannerBodyFight,
			int mannerSlang, int mannerSmoking, int mannerUniform, int mannerPayment, int mannerArrangement,
			int mannerReferee, int mannerTackle, int teamAbility) {
		super();
