...
public class Team {
	...
	public Team(String teamName, String emblem, String area, String stadiumInfo, String uniformColor, int uniformType,
			String foundingDate, String teamRegDate, TeamScore teamScore, List<TeamMember> teamMembers,
	...
	public Team(int teamId, String teamName, String emblem, String area, String stadiumInfo, String uniformColor,
			int uniformType, String foundingDate, String teamRegDate, TeamScore teamScore,
	...
	public String toString() {
		return "Team [teamId=" + teamId + ", teamName=" + teamName + ", emblem=" + emblem + ", area=" + area
				...
				+ ", foundingDate=" + foundingDate + ", teamRegDate=" + teamRegDate + ", teamScore="
				+ teamScore + ", teamMembers=" + teamMembers + ", votes=" + votes + ", matchSchedules="
