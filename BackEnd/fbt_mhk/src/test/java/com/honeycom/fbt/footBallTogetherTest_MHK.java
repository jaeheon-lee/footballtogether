...
public class footBallTogetherTest_MHK {
	...
	public void unit() throws Exception {
		 ...
		 * 
		 * List<User> rVo = session.selectList("sql.footBAllTogether.mapper2.selectUser",
		 ...
		 * List<TeamMember> rVo =
		 * session.selectList("sql.footBAllTogether.mapper2.selectTeamMembers", tVo);
		 ...
		 * session.selectList("sql.footBAllTogether.mapper2.selectTeams", tVo);
		 * System.out.println(rVo);
		 */
		/* <!--3. 팀 : team 끝--> */
		 ...
		 * session.selectList("sql.footBAllTogether.mapper2.selectTeamMannerScore", tVo);
		 * System.out.println(rVo);
		 */
		 ...
		 * session.selectList("sql.footBAllTogether.mapper2.selectVotes", vVo);
		 * System.out.println(rVo);
		 */
		/* <!-- 5.투표: Vote 끝--> */
		 ...
		 * List<VoteResult> rVo =
		 * session.selectList("sql.footBAllTogether.mapper2.selectVoteResults", vVo);
		 * System.out.println(rVo);
		 */
		/* <!--6.투표결과:voteResult 끝--> */
		 ...
		 * session.selectList("sql.footBAllTogether.mapper2.selectMatchInfo", mVo);
		 * System.out.println(rVo);
		 */
		 ...
		 * = session.selectList("sql.footBAllTogether.mapper2.selectAssignment", asVo);
		 * System.out.println(rVo);
		 */
		/* <!--8.양도:assignment 끝--> */
		 ...
		 * = session.selectList("sql.footBAllTogether.mapper2.selectEmployments", eVo);
		 * System.out.println(rVo);
		 */
		/* <!-- 9.용벙:employment 끝 --> */
		 ...
		 * session.selectList("sql.footBAllTogether.mapper2.selectSearch", sVo);
		 * System.out.println(rVo);
		 */
		/* <!-- 10. 상대팀 찾기:search 끝--> */
		 ...
		 * session.selectList("sql.footBAllTogether.mapper2.selectMatchSchedules", msVo);
		 ...
		 * session.selectList("sql.footBAllTogether.mapper2.selectAttendants", aVo);
		 * System.out.println(rVo);
		 */
		/* <!-- 12.참석자: attendant 끝--> */
		 ...
		 * rVo = session.selectList("sql.footBAllTogether.mapper2.selectMatchReviews",
...
//		System.out.println(list);
		...
		// insertMatch : 상대팀 평가 등록하기 -> myBatis 단위테스트 완료(컬럼 추가 전)
//		MatchReview mr = new MatchReview(1,5,5,5,5,5,5,5,5,5);
//		
//		boolean result = session.insert("sql.footBAllTogether.mapper2.insertMatchReview", mr) == 1 ? true : false;
//		session.commit();
//		System.out.println(result);
		
		
		// 선택한 소속팀의 모든 매치와 내 참석여부를 함께 가져오기
		// teamMemberId를 통한 참석여부는 controller에서 시행
//		MatchSchedule ms = new MatchSchedule();
//		ms.setHomeTeamId(1);
//		
//		List<MatchSchedule> msResult = session.selectList("sql.footBAllTogether.mapper2.getMyTeamMatchSchedules", ms);
//		System.out.println(msResult);
//		
		// team_manner_score <- upsertMatchReview
//		TeamMannerScore tms = new TeamMannerScore(2,3,7,6,4,8,7,8,6,5,4,9);
//		boolean tmsResult = session.insert("sql.footBAllTogether.mapper2.upsertMatchReview", tms) == 1 ? true : false;
//		session.commit();
//		System.out.println(tmsResult);
		
		// insertMatchInfo & upsertSearch
//		MatchInfo mi = new MatchInfo();
//		mi.setSchedule("2020-09-06");
//		mi.setStadium("서대문구 종합체육관");
//		mi.setStadiumType("11:11");
//		mi.setHomeTeamId(3);
//		boolean miResult = session.insert("sql.footBAllTogether.mapper2.insertMatchInfo", mi) == 1 ? true : false;
//		session.commit();
//		System.out.println(miResult);
//		System.out.println(mi);
//		
//		Search search = new Search();
//		search.setTeamIdGiver(mi.getHomeTeamId());
//		search.setTeamMemberIdGiver(10);
//		search.setMatchInfoId(mi.getMatchInfoId());
//		session.insert("sql.footBAllTogether.mapper2.upsertSearch", search);
//		session.commit();
//		System.out.println(search);
//
//		search.setTeamMemberIdGiver(10);
//		search.setMatchInfoId(mi.getMatchInfoId());
//		search.setTeamIdTaker(2);
//		search.setTeamMemberIdTaker(8);
//		search.setSearchStatus(3);
//		
//		session.insert("sql.footBAllTogether.mapper2.upsertSearch", search);
//		session.commit();
//		System.out.println(search);
		...
		// getSearchs : 등록매치 현황 가져오기
		List<MatchInfo> result = session.selectList("sql.footBAllTogether.mapper2.getSearchs");
		System.out.println(result);
